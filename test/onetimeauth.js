...
var key = Buffer("eea6a7251c1e72916d11c2cb214d3c25"+
                "2539121d8e234e652d651fa4c8cff880", "hex");
var msg = Buffer("8e993b9f48681273c29650ba32fc76ce"+
...
test("onetimeauth", function(t) {
    var a = Buffer("f3ffc7703f9400e52a7dfb4b3d3305d9", "hex");
    t.equivalent(n.onetimeauth(msg, key), a);
    n.onetimeauth_verify(a, msg, key);

    t.throws(function() {n.onetimeauth(msg, key, "extra");},
             {name: "Error", message: "Args: message, key"});
    t.throws(function() {n.onetimeauth(0, key);},
             {name: "TypeError", message: "arg[0] 'message' must be a Buffer"});
    t.throws(function() {n.onetimeauth(msg, 0);},
             {name: "TypeError", message: "arg[1] 'key' must be a Buffer"});

    t.throws(function() {n.onetimeauth_verify(a, msg, key, "extra");},
             {name: "Error", message: "Args: authenticator, message, key"});
    t.throws(function() {n.onetimeauth_verify(0, msg, key);},
             {name: "TypeError", message: "arg[0] 'authenticator' must be a Buffer"});
    t.throws(function() {n.onetimeauth_verify(a, 0, key);},
             {name: "TypeError", message: "arg[1] 'message' must be a Buffer"});
    t.throws(function() {n.onetimeauth_verify(a, msg, 0);},
